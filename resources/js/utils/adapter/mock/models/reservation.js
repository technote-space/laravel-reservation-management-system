...
export default item => Object.assign({}, item, {
    ...
    end_datetime: item.end_date + 'T10:00:00.000+0900',
    is_past: moment(item.end_date + 'T10:00:00.000+0900').isBefore(),
    is_present: !moment(item.start_date + 'T15:00:00.000+0900').isAfter() && !moment(item.end_date + 'T10:00:00.000+0900').isBefore(),
