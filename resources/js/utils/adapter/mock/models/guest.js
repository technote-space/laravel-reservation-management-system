...
export default item => {
    const reservations = orderBy(store.getters[ 'mock/searchAll' ]('reservations', reservation => reservation.guest_id === item.id), ['start_date'], 'desc');
    return Object.assign({}, item, {
        detail: detail(store.getters[ 'mock/search' ]('guestDetails', detail => detail.guest_id === item.id)),
